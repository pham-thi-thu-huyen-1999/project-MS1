        ...
        <div v-if="notCruncher.list && notCruncher.list.length > 0" class="wrapper-list">
            ...
            <div class="list-view">
                <div class="row no-gutters item-list align-items-center" v-for="(item, index) in notCruncher.list" :key="index">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-8" v-if="item.supervisorManager">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5 col-8 name" v-else>
                        {{item.businessInfo && item.businessInfo.abnCode}}
                    </div>
