            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input  class="form-control form-input"  type="password" required name="password" minlength="4" v-model="oldPassword">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input  class="form-control form-input"  type="password" v-model="password" required name="newpassword" minlength="4">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input class="form-control form-input"  type="password" v-model="confirmPassword" required name="confirmpassword" minlength="4">
