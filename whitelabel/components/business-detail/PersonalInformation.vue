            ...
            <div class="row form-box">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input :disabled="clientId" class="form-control form-input" required name="firstname" type="text" v-model="data.firstName">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label class="form-label">LAST NAME</label>
                        <input :disabled="clientId" class="form-control form-input" type="text" required name="lastname" v-model="data.lastName">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input :disabled="clientId" class="form-control form-input" type="text" placeholder="100 Example St, Suburb, City, Country, 00000" required name="residentialaddress" minlength="4" v-model="data.personalInfo.address">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input :disabled="clientId"  class="form-control form-input" type="text" placeholder="100 Example St, Suburb, City, Country, 00000" required name="postaladdress" minlength="4" v-model="data.personalInfo.postalName">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" disabled class="form-input form-control" v-model="data.email" required name="email">
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label class="form-label">CONTACT NUMBER</label>
                        <input :disabled="clientId" type="text" class="form-input form-control" placeholder=""  v-model="data.personalInfo.phone" required name="phone" phone>
        ...
        async getData() {
            try {
                ...
                if (result.data) {
                    ...
                    this.data.personalInfo.postalName = result.data.address ? result.data.address : null;
