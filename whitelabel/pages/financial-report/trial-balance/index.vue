                                ...
                                <div class="box-item pdr-15">
                                    <template v-if="list.monthlyReport && list.monthlyReport.length">
                                        ...
                                        <div class="row row-item" v-for="(item, index) in list.monthlyReport" :key="index">
                                            ...
                                            <div class="col-4 align-self-center text-right">
                                                <div class="btn-group">
                                                    <button :disabled="!item.status" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-normal grey">download</button>                     
                                                    <ul class="dropdown-menu" style="max-width: 120px;left: 87px !important;">
                                                        <li @click="exportFile(financial.TrialBalance, item)"><a class="dropdown-menu-link"> <img alt="" title="" src="~/assets/images/icon-pdf.svg" >Export as PDF</a></li>
                                                        <li @click="exportFile(financial.TrialBalance, item, true)"><a class="dropdown-menu-link"><img alt="" title="" src="~/assets/images/icon-csv.svg">Export as CSV</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <template v-if="list.quarterReport && list.quarterReport.length">
                                        ...
                                        <div class="row row-item" v-for="(item, index) in list.quarterReport" :key="index + '-s'">
                                            ...
                                            <div class="col-3 align-self-center">
                                                <span class="item-normal">Trial Balance {{ item.startMonthName }} {{ item.startYear }} to {{ item.endMonthName }} {{ item.endYear }}</span>
                                            </div>
                                            <div class="col align-self-center text-right">
                                                <span class="item-normal uppercase grey" v-if="!item.status"> <img style="margin-top: -2px;" src="/images/crunch-icon.svg"/> Cruncher not yet completed </span>
                                            </div>
                                    ...
                                    <template v-if="list.finalYearReport && list.finalYearReport.beginYear">
                                        <div class="row mt-20"><label class="title-section">FINANCIAL YEAR</label></div>
                                            <div class="row row-item">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    <span class="item-normal">Trial Balance {{ beginDate.monthName }} {{ list.finalYearReport && list.finalYearReport.beginYear }} to {{ endDate.monthName }} {{ list.finalYearReport && list.finalYearReport.endYear }}</span>
                                                </div>
                                                <div class="col align-self-center text-right">
                                                ...
                                                <div class="col-4 align-self-center text-right">
                                                    <div class="btn-group">
                                                        <button :disabled="!list.finalYearReport || !list.finalYearReport.status" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn-normal grey">download</button>                     
                                                        <ul class="dropdown-menu" style="max-width: 120px;left: 87px !important;">
                                                            <li @click="exportFile(financial.TrialBalance, {})"><a class="dropdown-menu-link"> <img alt="" title="" src="~/assets/images/icon-pdf.svg" >Export as PDF</a></li>
                                                            <li @click="exportFile(financial.TrialBalance, {}, true)"><a class="dropdown-menu-link"><img alt="" title="" src="~/assets/images/icon-csv.svg">Export as CSV</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
    ...
    methods: {
        ...
        async exportFile(type, date, isCsv = false) {
            ...
            if (isCsv)
                ...
                result = await this.$services.reportService.exportFinancial(type, this.client._id, beginMonth, beginYear, endMonth, endYear);
