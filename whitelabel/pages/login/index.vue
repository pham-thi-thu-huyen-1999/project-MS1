        ...
        <div class="form-box">
            ...
            <kform :state="formLogin" name="formLogin" @submit.prevent='login'>
                <div class="form-group">
                    ...
                    <input v-model="email" type="email" name="email" required class="form-control form-input">
                ...
                <div class="form-group">
                    ...
                    <input v-model="password" type="password" required name="password" id="ip_password" class="form-control form-input">
