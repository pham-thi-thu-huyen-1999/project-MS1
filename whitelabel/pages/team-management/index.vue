                                            ...
                                            <div class="box-item box-loading" v-if="manager.total">
                                                ...
                                                <div class="row row-item" v-for="(client, index) in manager.clients" :key="index">
                                                    <div class="col-3 align-self-center">
                                                        <img class="item-img" :src="client.avatar || '/images/default-avatar.jpg'" :title="client.fullName"/>
                                                    ...
                                                    <div class="col-4 align-self-center">
                                                        <img class="item-img" v-if="client.permission && client.permission.manager" :src="client.permission.manager.avatar || '/images/default-avatar.jpg'" :title="client.permission.manager.fullName"/>
            ...
            if (data) {
                ...
                if (result.data) {
                    manager.clients.forEach(client => {
                        ...
                        if (client.permission.manager && client.permission.manager.avatar) {
                            client.permission.manager.avatar = mapUrlGoogleStorage(client.permission.manager.avatar);
                        }
                    });
                    this.$forceUpdate();
                }
