            ...
            <div class="infor-bank">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="infor-detail">BSB: {{userConnectedBank && userConnectedBank.account && userConnectedBank.account.bankTransferCode ? userConnectedBank.account.bankTransferCode[0].id : 'NA'}} | Account No. {{userConnectedBank && userConnectedBank.account && userConnectedBank.account.accountNumber ? userConnectedBank.account.accountNumber: ''}}</div>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async getKeyPem() {
            if ((!this.keyAlias || !this.keyPem) && process.env.environment === 'Production') {
                this.$setLoading();
