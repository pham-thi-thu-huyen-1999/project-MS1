                            ...
                            <div class="box">
                                ...
                                <div class="box-item pdr-15">
                                    <template v-if="list.monthlyReport && list.monthlyReport.length">
                                        ...
                                        >
                                            ...
                                            <div class="col-6 align-self-center text-right">
                                                <div class="btn-group">
                                                    <button
                                                        @click="btnPreviewGst(financial.GST, item)"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                    >preview summary</button>
                                                    <button
                                                        @click="btnPreviewGst(financial.GSTDetail, item)"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                ...
                                                <div class="btn-group">
                                                    <button
                                                        ...
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                    >download gst summary</button>
                                                    <ul
                                                        class="dropdown-menu"
                                                        style="max-width: 120px;left: 87px !important;"
                                                    >
                                                        <li @click="exportGst(financial.GST, item)"><a class="dropdown-menu-link"> <img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-pdf.svg"
                                                                >Export as PDF</a></li>
                                                        <li @click="exportGst(financial.GST, item, true)"><a class="dropdown-menu-link"><img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-csv.svg"
                                                                >Export as CSV</a></li>4
                                                    </ul>
                                                </div>
                                                <div class="btn-group">
                                                    <button
                                                        ...
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                    >download gst detail</button>
                                                    <ul
                                                        class="dropdown-menu"
                                                        style="max-width: 120px;left: 87px !important;"
                                                    >
                                                        <li @click="exportGst(financial.GSTDetail, item)"><a class="dropdown-menu-link"> <img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-pdf.svg"
                                                                >Export as PDF</a></li>
                                                        <li @click="exportGst(financial.GSTDetail, item, true)"><a class="dropdown-menu-link"><img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-csv.svg"
                                                                >Export as CSV</a></li>
                                    ...
                                    <template v-if="list.finalYearReport && list.finalYearReport.beginYear">
                                        ...
                                        <div class="row row-item">
                                            <div class="col-2 align-self-center width-120">
                                                <span class="item-normal">{{ yearSelect.beginDate.month && convertMonthToWord(yearSelect.beginDate.month).substring(0, 3)}} {{ list.finalYearReport && list.finalYearReport.beginYear && list.finalYearReport.beginYear.toString().substring(2,4)}} - {{ yearSelect.beginDate.month && convertMonthToWord(yearSelect.endDate.month).substring(0, 3)}} {{ list.finalYearReport && list.finalYearReport.beginYear && list.finalYearReport.endYear.toString().substring(2,4)}}</span>
                                            </div>
                                            <div class="col-3 align-self-center">
                                                <span class="item-normal">GST {{ yearSelect.beginDate.month && convertMonthToWord(yearSelect.beginDate.month) }} {{ list.finalYearReport && list.finalYearReport.beginYear }} to {{ yearSelect.beginDate.month && convertMonthToWord(yearSelect.endDate.month) }} {{ list.finalYearReport && list.finalYearReport.endYear }}</span>
                                            </div>
                                            <div class="col align-self-center text-right">
                                                <span
                                                    class="item-normal uppercase grey"
                                            ...
                                            <div class="col-6 align-self-center text-right">
                                                <div class="btn-group">
                                                    <button
                                                        @click="btnPreviewGst(financial.GST, list.finalYearReport)"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                    >preview summary</button>
                                                    <button
                                                        @click="btnPreviewGst(financial.GSTDetail, list.finalYearReport)"
                                                        aria-haspopup="true"
                                                        aria-expanded="false"
                                                        class="btn-normal grey"
                                                    >preview detail</button>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul
                                                        ...
                                                        style="max-width: 120px;left: 87px !important;"
                                                    >
                                                        <li @click="exportGst(financial.GST, {})"><a class="dropdown-menu-link"> <img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-pdf.svg"
                                                                >Export as PDF</a></li>
                                                        <li @click="exportGst(financial.GST, {}, true)"><a class="dropdown-menu-link"><img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-csv.svg"
                                                                >Export as CSV</a></li>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul
                                                        ...
                                                        style="max-width: 120px;left: 87px !important;"
                                                    >
                                                        <li @click="exportGst(financial.GSTDetail, {})"><a class="dropdown-menu-link"> <img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-pdf.svg"
                                                                >Export as PDF</a></li>
                                                        <li @click="exportGst(financial.GSTDetail, {}, true)"><a class="dropdown-menu-link"><img
                                                                    alt=""
                                                                    title=""
                                                                    src="~/assets/images/icon-csv.svg"
                                                                >Export as CSV</a></li>
...
export default {
    ...
    methods: {
        ...
        async btnPreviewGst(type, date, isCsv = false) {
        ...
        async exportGst(type, date, isCsv = false) {
            ...
            let result;
            if (isCsv) {
                result = await this.$services.reportService.exportFinancialCSV(
                    type,
                    this.clientId,
                    this.userId,
                    beginMonth,
                ...
                result = await this.$services.reportService.exportFinancial(
                    type,
                    this.clientId,
                    this.userId,
                    beginMonth,
