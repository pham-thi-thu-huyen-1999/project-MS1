                        ...
                        <div class="box-center">
                            <div class="box-content personal-info">
                                <div class="text-center wrapper-info">
                                    ...
                                    <img :src="data && data.profile && data.profile.avatar ? data.profile.avatar : '/images/default-avatar.jpg'" class="img-user rounded-circle" alt=""/>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="data.profile.firstName" class="form-input"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" v-model="data.profile.lastName" class="form-input"/>
                                            <span v-if="errorFirstName || errorLastName" class="tooltip-error" :class="{all: errorFirstName || errorLastName}">{{errorLastName}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Email</label>
                                    <input disabled v-model="data.profile.email" type="text" class="form-input"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Countries</label>
                                    <input type="text" @input="inputAddress()" v-model="data.personalInfo.address" placeholder="100 Example St, Suburb, City, Country, 00000" class="form-input"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="data.personalInfo.phone" class="form-input"/>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button @click="updateProfile()" class="form-btn">save changes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    methods: {
        async getProfile() {
            try {
                ...
                result = await this.$services.userService.getPersonalInfo();
                if (result.data) {
        ...
        async updateProfile() {
            ...
            let result = await this.$services.userService.updateProfile(dataUpdate);
            if (result.data) {
        ...
        async uploadAvatar(event) {
            ...
            if (!checkImage) {
                ...
                let {data, error} = await this.$services.userService.uploadMyAvatar(formData);
                if (error) {
                    this.$notify({
                        type: 'error',
