...
exports.default = {
    SYSTEM: {
        ...
        order: 1,
        productTypes: [
            CommonType_1.ProductType.Management,
            CommonType_1.ProductType.FreshNumber,
            CommonType_1.ProductType.Justdone,
            CommonType_1.ProductType.WhiteLabel
        ],
        claim: {
            ACCESS: {
                code: 1001,
    ...
    PRODUCT: {
        ...
        claim: {
            GET: {
                ...
                roleCodes: [
                    CommonType_1.RoleCode.Self,
                    CommonType_1.RoleCode.RegionAdmin,
                    CommonType_1.RoleCode.Supervisor,
                    CommonType_1.RoleCode.CaseManager,
                    CommonType_1.RoleCode.TaxAgent,
                    CommonType_1.RoleCode.ProductAdmin,
                    CommonType_1.RoleCode.ProductManager,
                    CommonType_1.RoleCode.Client
                ]
            },
            CREATE: {
                code: 2101,
    ...
    MESSAGE: {
        ...
        claim: {
            ...
            CREATE: {
                ...
                order: 101,
                roleCodes: [
                    CommonType_1.RoleCode.SuperAdmin
                ]
            },
            UPDATE: {
                code: 21201,
