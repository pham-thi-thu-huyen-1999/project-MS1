...
const CrunchSchema_1 = require("../dataAccess/schemas/CrunchSchema");
const BaseRepository_1 = require("./base/BaseRepository");
class CrunchRepository extends BaseRepository_1.default {
    constructor() {
        super(CrunchSchema_1.default);
    }
    create(data) {
...
exports.default = CrunchRepository;
