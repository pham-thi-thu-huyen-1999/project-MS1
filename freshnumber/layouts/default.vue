...
export default {
    ...
    methods: {
        async getGlobal(head) {
            let productId;
            if (this.$store.state.userAuth && this.$store.state.userAuth.permission.product._id)
                productId = this.$store.state.userAuth.permission.product._id;
            else if (this.$store.state.userAuth && this.$store.state.userAuth.permission.product)
