<template>
  <div class="box-content">
    <div class="section-business">
        ...
        <kform :state="updatebusinessInfo" name="updatebusinessInfo" @submit.prevent='updateBusinessInfo'>
            <div class="row form-box">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label class="form-label">ABN</label>
                        <input :disabled="data.user.businessInfo.abnCode && data.user.businessInfo.abnCode.length === 11" @input="lookupABN" class="form-control form-input" type="text" name="abn" required minlength="4" v-model="data.user.businessInfo.abnCode" :placeholder="abnTemplate">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <input :disabled="clientId" @input="inputBusinessAddress()" class="form-control form-input" name="businessAddress" required minlength="4" type="text" placeholder="100 Example St, Suburb, City, Country, 00000" v-model="data.user.businessInfo.address">
...
export default {
    ...
    methods: {
        ...
        async updateBusinessInfo() {
            if (this.updatebusinessInfo.$invalid) return;
            let dataBusiness = {};
