        ...
        <div class="row general">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                        ...
                        <div class="box-center">     
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12">
                                        <input disabled type="text" class="form-control form-input" v-model="data.config.domain">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-2 col-xs-12">
                    ...
                    <popup-confirm id="popup-image-product-precis" ref="popupConfirm" :title="confirm.title" :buttonName1="confirm.buttonName1"/>
                </div>
...
export default {
    ...
    methods: {
        ...
        async getProduct() {
            let productId = this.$store.state.userAuth && this.$store.state.userAuth.permission.product._id;
            if (!productId)
                return {};

            let {data, error} = await this.$services.userService.getProduct(productId);
            if (error)
                console.log('Get product General settings error: ', error);
            if (data) {
                if (data.logo)
