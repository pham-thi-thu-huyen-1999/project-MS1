...
export default {
    ...
    methods: {
        ...
        async getInvited() {
            let {data, error} = await this.$services.reportService.getClientInviteds(this.productCode, this.clientInvites.page, this.clientInvites.limit);
            if (error)
        ...
        async getNotAssigns() {
            let {data, error} = await this.$services.reportService.getClientNotassigned(this.productCode, this.clientNotAssigns.page, this.clientNotAssigns.limit);
            if (error)
                EventBus.$emit('NOTIFICATION_ERROR', {title: 'Error', description: error.message});
            if (data) {
        ...
        async getNotCruncher() {
            let {data, error} = await this.$services.reportService.getlistNotcruncher(this.productCode, this.notCruncher.page, this.notCruncher.limit);
            if (error)
                EventBus.$emit('NOTIFICATION_ERROR', {title: 'Error', description: error.message});
            else
        ...
        async getFinishCruncher() {
            let {data, error} = await this.$services.reportService.getlistFinishcruncher(this.productCode, this.finishCruncher.page, this.finishCruncher.limit);
            if (error)
                EventBus.$emit('NOTIFICATION_ERROR', {title: 'Error', description: error.message});
            else {
        ...
        async getClients() {
            let {data, error} = await this.$services.reportService.getAnalyticClients(this.productCode);
            if (error)
                EventBus.$emit('NOTIFICATION_ERROR', {title: 'Error', description: error.message});
            else {
        ...
        async getManagers() {
            let {data, error} = await this.$services.reportService.getAnalyticManagers(this.productCode);
            if (error)
                EventBus.$emit('NOTIFICATION_ERROR', {title: 'Error', description: error.message});
            else
