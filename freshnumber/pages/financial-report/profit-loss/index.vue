                                            ...
                                            <div class="col-4 align-self-center text-right">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" style="max-width: 120px;left: 87px !important;">
                                                        <li @click="exportFile(financial.ProfitLoss, item)"><a class="dropdown-menu-link"> <img alt="" title="" src="~/assets/images/icon-pdf.svg" >Export as PDF</a></li>
                                                        <li @click="exportFile(financial.ProfitLoss, item, true)"><a class="dropdown-menu-link"><img alt="" title="" src="~/assets/images/icon-csv.svg">Export as CSV</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <template v-if="list.finalYearReport && list.finalYearReport.beginYear">
                                        <div class="row mt-20"><label class="title-section">FINANCIAL YEAR</label></div>
                                            <div class="row row-item">
                                                ...
                                                <div class="col-3 align-self-center">
                                                    <span class="item-normal">Profit & Loss {{ beginDate.monthName }} {{ list.finalYearReport && list.finalYearReport.beginYear }} to {{ endDate.monthName }} {{ list.finalYearReport && list.finalYearReport.endYear }}</span>
                                                </div>
                                                <div class="col align-self-center text-right">
                                                ...
                                                <div class="col-4 align-self-center text-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" style="max-width: 120px;left: 87px !important;">
                                                            <li @click="exportFile(financial.ProfitLoss, {})"><a class="dropdown-menu-link"> <img alt="" title="" src="~/assets/images/icon-pdf.svg" >Export as PDF</a></li>
                                                            <li @click="exportFile(financial.ProfitLoss, {}, true)"><a class="dropdown-menu-link"><img alt="" title="" src="~/assets/images/icon-csv.svg">Export as CSV</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
