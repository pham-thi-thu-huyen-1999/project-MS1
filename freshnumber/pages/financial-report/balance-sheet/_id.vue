                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                            <div class="dropdown normal-btn">
                                <nuxt-link to="/financial-report/template" class="btn dropdown-toggle not-arrow bg-grey">
                                    BACK TO LIST
                                </nuxt-link>
                            </div>
                        </div>
                    ...
                    <div class="report-review">
                        ...
                        <div class="report-frame">
                            ...
                            <div class="content">
                                <table>
                                    <tbody>
                                        <tr v-for="(item, index) in dataTemplate" :class="{underlined: +item.type.underlined === 1, 'font-bold': +item.type.bold === 1}" :key="index">
...
export default {
    ...
    methods: {
        getTemplate(id) {
            let {data, error} = this.$services.reportService.getTemplate(id);
            if (data)
