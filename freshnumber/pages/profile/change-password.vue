                        ...
                        <div class="box-center">
                            ...
                            <div class="box-content change-password">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" v-model="oldPassword" class="form-input" name="oldPassword" required minlength="4"/>
                                    <!-- <span class="icon-war" :class="{active : errorOldPassword}"><span class="tooltip-error">{{errorOldPassword}}</span></span> -->
                                </div>
                                <div class="form-group">
                                    <label class="form-label">NEW password</label>
                                    <input type="password" v-model="password" class="form-input" name="password" required minlength="4"/>
                                    <!-- <span class="icon-war" :class="{active : errorPassword}"><span class="tooltip-error">{{errorPassword}}</span></span> -->
                                </div>
                                <div class="form-group">
                                    <label class="form-label">confirm password</label>
                                    <input type="password" :confirm-pass="password" v-model="confirmPassword" class="form-input" name="confirmPassword" required minlength="4"/>
