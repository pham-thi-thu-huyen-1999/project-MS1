                            ...
                            <kform :state="profile" name="profile" @submit.prevent='updateProfile'>
                                <div class="box-content personal-info">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" v-model="data.profile.firstName" class="form-input" name="firstName" required minlength="4"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-12">
                                            <div class="form-group">
                                                <label class="form-label">Last Name</label>
                                                <input type="text" v-model="data.profile.lastName" class="form-input" name="lastName" required minlength="4"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled v-model="data.profile.email" type="text" class="form-input" name="email" required />
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Countries</label>
                                        <input type="text" @input="inputAddress()" v-model="data.personalInfo.address" placeholder="100 Example St, Suburb, City, Country, 00000" class="form-input" name="countries" required minlength="4"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="data.personalInfo.phone" class="form-input" name="phone" required phone/>
